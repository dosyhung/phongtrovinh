                                ...
                                @foreach($introduce as $intro)
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            ...
                                            @can('show-profile')
                                                <a data-toggle="modal" href="#modal-id{{$intro->id}}"
                                                   class="btn btn-danger"><i class="fa fa-trash-o"
                                                                             aria-hidden="true"></i></a>
                                                <a href="{{route('introduce.edit',['id'=>$intro->id])}}"
                                    ...
                                    <!--Modal xác nhận xóa--->
                                    <div class="modal fade" id="modal-id{{$intro->id}}">
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-footer">
                                                    ...
                                                    <button type="button" class="btn btn-primary"><a
                                                                href="{{route('introduce.delete',['id'=>$intro->id])}}">Delete</a>
                                                    </button>
                                                </div>
                                            </div>
                                        </div>
