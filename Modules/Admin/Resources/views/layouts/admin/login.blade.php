...
<div class="login-box">
    <div class="login-logo">
        <a href="#" title="phongtrovinh.com"><img src="{{asset('images/logo_phongtro.png')}}" width="60px" alt=""></a>
    </div>
    <!-- /.login-logo -->
    <div class="login-box-body">
        <p class="login-box-msg">Chào Mừng Đến Với Hệ Thống Quản Lý Phòng Trọ</p>
