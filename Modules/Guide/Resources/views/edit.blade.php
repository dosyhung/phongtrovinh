                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group {{$errors->has('sl_type') ? 'has-error' : ''}}">
                                        ...
                                        <select class="form-control" name="sl_type">
                                            ...
                                            <option value="1" {{$guide->type ==1 ? 'selected' : ''}}>Hướng Dẫn Đăng Tin</option>
                                            <option value="2" {{$guide->type ==2 ? 'selected' : ''}}>Hướng Dẫn Nạp Tiền</option>
                                            <option value="3" {{$guide->type ==3 ? 'selected' : ''}}>Hướng Dẫn Đăng Ký Tài Khoản</option>
                                        </select>
