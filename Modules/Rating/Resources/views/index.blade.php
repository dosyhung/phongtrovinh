        ...
        <section class="content-header">
            <small>
                <ol class="breadcrumb">
                    ...
                    <li class="active">Xem Đánh Giá</li>
                </ol>
            </small>
        </section>
        <!-- Main content -->
                        ...
                        <div class="box-body">
                            <table id="example1" class="table table-bordered table-striped">
                                ...
                                @foreach($rating as $rate)
                                    <tr>
                                        <td class="text-center">{{$rate->name}}</td>
                                        ...
                                        <td class="text-center">
                                            ...
                                            @can('show-profile')
                                                <a data-toggle="modal" href="#modal-id{{$rate->id}}"
                                                   class="btn btn-danger"><i class="fa fa-trash-o"
                                                                             aria-hidden="true"></i></a>
                                                <a href="{{route('admin.edit',['id'=>$rate->id])}}"
                                                   class="btn btn-warning"><i class="fa fa-pencil"
                                                                              aria-hidden="true"></i></a>
                                        @endcan
                                        <!----- Kết Thúc Kiểm Tra nếu người dùng là Admin thì mới có quyền xóa hoặc sửa------->
                                            <a href="{{route('admin.detail',['id'=>$rate->id])}}"
                                               class="btn btn-info"><i
                                                        class="fa fa-info-circle" aria-hidden="true"></i></a>
                                        </td>
                                    </tr>
                                    <!--Modal xác nhận xóa--->
                                    <div class="modal fade" id="modal-id{{$rate->id}}">
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-footer">
                                                    ...
                                                    <button type="button" class="btn btn-primary"><a
                                                                href="{{route('admin.delete',['id'=>$rate->id])}}">Delete</a>
                                                    </button>
                                                </div>
                                            </div>
                                        </div>
